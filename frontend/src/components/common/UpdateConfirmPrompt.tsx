  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-update-bg">
      <div className="bg-update-card-bg rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
        <h2 className="text-2xl font-bold text-update-primary mb-2">Update Survey?</h2>
        <p className="mb-6 text-update-text">Are you sure you want to update the existing survey?</p>
