        ...
        <div className="max-h-96 overflow-y-auto border border-gray-200 rounded-lg">
          <table className="w-full text-left">
            ...
            <thead className="sticky top-0 bg-purple-100 z-10">
              <tr>
                <th className="px-3 py-2 font-semibold border-b border-gray-200">#</th>
                <th className="px-3 py-2 font-semibold border-b border-gray-200">Question</th>
                <th className="px-3 py-2 font-semibold border-b border-gray-200">Category</th>
                <th className="px-3 py-2 font-semibold border-b border-gray-200">Level</th>
                <th className="px-3 py-2 font-semibold text-green-700 border-b border-gray-200">Answered</th>
                <th className="px-3 py-2 font-semibold text-amber-700 border-b border-gray-200">Skipped</th>
                <th className="px-3 py-2 font-semibold text-red-700 border-b border-gray-200">Skip%</th>
                <th className="px-3 py-2 font-semibold border-b border-gray-200">Total</th>
              </tr>
            </thead>
            <tbody>
              {questions.length === 0 ? (
